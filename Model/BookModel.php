...
class BookModel
{
    ...
    {
        $arr = [];
        $sth = $this->pdo->query("SELECT book.id,book.title,book.price,book.description,book.status,style.title AS style FROM book,style WHERE book.style_id=style.id GROUP BY id DESC");
